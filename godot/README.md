...
`-Pack` repacks sprites first; `-Probe "battle,12,tank"` runs probes and prints the PROBE lines).
...
`user://probe_battle.png`. Scene: battle. `--probe=battle,12,post=N` applies
