...
#include "EmberkeepUITypes.generated.h"
 ...
 */
UENUM(BlueprintType)
enum class EEmberkeepStance : uint8
{
...
inline FString EmberkeepStanceToString(EEmberkeepStance Stance)
{
	switch (Stance)
	{
		case EEmberkeepStance::Charge: return TEXT("Charge");
		case EEmberkeepStance::Hold:   return TEXT("Hold");
		case EEmberkeepStance::Rally:  return TEXT("Rally");
		case EEmberkeepStance::Follow:
...
struct FEmberkeepSquad
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Squad")
	EEmberkeepStance Stance = EEmberkeepStance::Follow;
