...
- 2026-07-31 · `task-132` · proposed → **approved** · Mock up the battle composition options against the measured field extents
- 2026-07-31 · `task-133` · proposed → **approved** · Make the camera contain every live unit at the framing the owner picks
- 2026-07-31 · `task-132` · approved → **in-progress** · Mock up the battle composition options against the measured field extents — dispatched to teammate `composition-mockup` at model `sonnet`
- 2026-07-31 · `task-132` · in-progress → **parked** · Mock up the battle composition options against the measured field extents — Owner call 2026-08-01: mockup skipped. The math needed to choose was derived in the lead session instead — fit-to-bbox with a forward focus offset is the only option keeping soldiers readable, so task-133 builds it directly. Mockup's containment numbers were wrong (radius/span confusion, arc read as 150 not the shipped 120) and are superseded by the figures in task-133's prompt.
- 2026-07-31 · `task-133` · approved → **in-progress** · Make the camera contain every live unit at the framing the owner picks — dispatched to teammate `camera-fit` at model `sonnet`
