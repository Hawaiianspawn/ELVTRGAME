...
**Reading it:** the break sits between HP=400 (still a total wipe, 3.96 of
250 enemy left) and HP=600 (retinue wins, 4.23 survivors) — roughly
...
--- cell 4: scenario:Retinue.Composition[UnitType=spearmen].Count=160 ---
  ...
  Enemy:   250 -> 5.69 survivors
  Result: retinue_wiped  (elapsed 9.0s)

--- cell 5: scenario:Retinue.Composition[UnitType=spearmen].Count=200 ---
  Retinue: 208 -> 32.18 survivors
  Enemy:   250 -> 0.00 survivors
  Result: enemy_wiped  (elapsed 27.0s)

--- cell 6: scenario:Retinue.Composition[UnitType=spearmen].Count=250 ---
  Retinue: 258 -> 84.94 survivors
  Enemy:   250 -> 0.00 survivors
  Result: enemy_wiped  (elapsed 19.8s)
...
5.69 of 250 enemy left) and 200 (retinue wins, 32.18 survivors) — i.e. even
